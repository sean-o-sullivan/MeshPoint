...
//         message += String(msg.sensor_data[i], 5) + " ";
//     }
//     message += "\n";
...
//         if(bufferCount<SENSOR_BUFFER_SIZE){sensor_buffer[bufferCount] = a_absolute; bufferCount++;}
//         else
//         {
//             float maxInBuffer = 0;
//             for (int i; i<SENSOR_BUFFER_SIZE; i++){
//                 if(sensor_buffer[i]>maxInBuffer){
//                     maxInBuffer=sensor_buffer[i];
//                 }
//             }
//             sensor_data[arrayCount] = maxInBuffer;
//             Serial.println(maxInBuffer);
//             arrayCount++;
//             bufferCount=0;
//         }
